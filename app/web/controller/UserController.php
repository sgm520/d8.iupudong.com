...
class UserController extends HomeBaseController{
    ...
    public function user(){
        ...
        $u_data = $user
            ...
            ->field("id,tel,last_tel,income,tx,ktx,user_nickname,avatar,vip,is_real,al_pay_name,al_pay_account,is_band,real_name,id_card")
            ->find();
    ...
    public function tx_list(){
        ...
        $list = $txModel->where("user_id",$this->userId)->select();
        foreach($list as $k=>$v){
    ...
    public function income_details(){
        $detail = Db::name("user_balance_log")->where("user_id",$this->userId)->order('id','desc')->select()->toArray();
